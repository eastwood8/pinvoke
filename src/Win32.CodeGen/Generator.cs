...
namespace Win32.CodeGen
{
    ...
    public class Generator : IDisposable
    {
        ...
        private const string MetadataTypesNamespace = "Microsoft.Windows.Sdk.Win32";
        private const string InteropDecorationNamespace = "Microsoft.Windows.Sdk.Win32.Interop";
        ...
        private const string BaseTypeAttribute = "NativeInheritanceAttribute";
        ...
        private TypeDeclarationSyntax? CreateInterface(TypeDefinition typeDef)
        {
            ...
            foreach (MethodDefinitionHandle methodDefHandle in allMethods)
            {
                ...
                InvocationExpressionSyntax vtblInvocation = InvocationExpression(MemberAccessExpression(SyntaxKind.PointerMemberAccessExpression, vtblFieldName, innerMethodName))
                    ...
                    .AddArgumentListArguments(parameterList.Parameters.Select(p => Argument(IdentifierName(p.Identifier.ValueText)).WithRefKindKeyword(p.Modifiers.FirstOrDefault())).ToArray());
